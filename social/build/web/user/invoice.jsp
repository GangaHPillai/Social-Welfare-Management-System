...
String sql1="select otp from user_reg where email='"+un+"'";
String k[][]=db.getDatas(sql1,null);
...
sql=" select address from user_reg where email='"+un+"'";
String add[][]=db.getDatas(sql,null);
String sql3="select ifnull(max(oid),0)+1 from myorder";
String f[][]=db.getDatas(sql3, null);
...
String t[][]=db.getDatas(sql,null);
                           sql="insert into myorder values('"+t[0][0]+"','"+un+"','"+prdt+"','"+org_name+"','"+price+"','"+img+"','"+d+"','"+add[0][0]+"','Paid','Processing');";  
