...
<%
    ...
    String uid=(String)session.getAttribute("username");
             ...
             sql= "select * from user_reg where email='"+uid+"'";
           // String[] pr = {uid};
           ...
           try {
            ...
            String gender1 = request.getParameter("t2");
            ...
            String sql1="update user_reg set name=?,gender=?,email=?,phno=? where email=?";
            String[] pr1 = {name1,gender1,email1,phn,uid};
...
<div style="position:relative;width:1500px;height:1000px;">
    <h1 style="position:relative;left:600px;top:150px;"><font color="gray">EDIT PROFILE</font></h1>
    <form action="" method="post">
        ...
        <table style="position:relative;left:400px;" >
            ...
            <tr><td align="right"><font color="green">Gender:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <input type="text" name="t2" id="txt3" value="<%=gender%>" placeholder="Enter gender" style="width: 500px;" readonly=""/>
                </td>
            </tr>
             <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
