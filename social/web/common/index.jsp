				...
				<div id="navbar" class="navbar-collapse collapse">
					<div class="nav_right_top">
						<ul class="nav navbar-nav">
							...
							<li>
                                                            <a class="scroll" href="user_login.jsp">Login</a>
							</li>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
                                                                            <a class="scroll" href="membership_reg.jsp">Member</a>
									</li>
									<li>
                                                                            <a class="scroll" href="user_reg.jsp    ">User</a>
									</li>
								</ul>
							</li>

							<li>
                                                            <a class="scroll" href="contact.jsp">Contact</a>
							</li>
