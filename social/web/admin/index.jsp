						...
						<ul class="nav navbar-nav">
							...
							<li>
								...
								<ul class="dropdown-menu">
									<li>
                                                                            <a class="scroll" href="vieworphanage.jsp">Orphange</a>
									</li>
									<li>
                                                                            <a class="scroll" href="viewoldage.jsp">Oldage Home</a>
									</li>
                                                                        <li>
                                                                            <a class="scroll" href="viewwomen.jsp">Women Welfare</a>
									</li>
                                                                          <li>
                                                                              <a class="scroll" href="viewuser.jsp">Members </a>
									</li>
								</ul>
							</li>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a class="scroll" href="product.jsp?mode=orphanage">Orphange</a>
									</li>
									<li>
										<a class="scroll" href="product.jsp?mode=oldage_home">Oldage Home</a>
									</li>
                                                                        <li>
										<a class="scroll" href="product.jsp?mode=women_welfare">Women Welfare</a>
									</li>
								</ul>
							</li>
								...
								<ul class="dropdown-menu">
									<li>
                                                                            <a class="scroll" href="view_donation.jsp?mode=orphanage">Orphange</a>
									</li>
									<li>
                                                                            <a class="scroll" href="view_donation.jsp?mode=oldage_home">Oldage Home</a>
									</li>
                                                                        <li>
                                                                            <a class="scroll" href="view_donation.jsp?mode=womenwelfare">Women Welfare</a>
									</li>
								</ul>
							</li>
	...
	<div class="banner_bottom donate-log">
		<div class="donate-inner">
			...
			<div class="col-md-8 donate-info">
				...
				<p>Anyone who says ?They want to keep you down! But I can help you!? Is more motivated by their own need for social position that in helping you.
If you seek to genuinely help others, give them the tools they need to succeed after showing them how to do for themselves, and do so without regard for your own recognition!.</p>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
					...
					<ul class="rslides" id="slider4">
						<li>
							<div class="respon_info_img">
								<img src="../temp/images/banner3.jpg" class="img-responsive" alt="Relief">
							</div>
							<div class="banner_bottom_left">
								<h4>Feed For Hungry Child</h4>

								<p>We provide food to children and families all over the world, as well as training on the importance of a nutritious diet.</p>
								<p>With proper nutrition early in life, children can grow, develop and thrive to their full potential.</p>
								<div class="ab_button">
			...
			<div class="inner_sec_info_w3layouts">
				...
				<ul class="portfolio-area">
					...
					<li class="portfolio-item2" data-id="id-0" data-type="cat-item-4">
						<div>
							<span class="image-block img-hover">
								<a class="image-zoom" href="../temp/images/g1.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g1.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-1" data-type="cat-item-2">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g2.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g2.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-2" data-type="cat-item-1">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g3.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g3.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-3" data-type="cat-item-4">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g4.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g4.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-4" data-type="cat-item-3">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g5.jpg">

									<img src="../temp/images/g5.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-5" data-type="cat-item-2">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g6.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g6.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-6" data-type="cat-item-1">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g7.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g7.jpg" class="img-responsive" alt="Relief">
					...
					<li class="portfolio-item2" data-id="id-7" data-type="cat-item-1">
						<div>
							<span class="image-block">
								<a class="image-zoom" href="../temp/images/g8.jpg" rel="prettyPhoto[gallery]">

									<img src="../temp/images/g8.jpg" class="img-responsive" alt="Relief">
							...
							<div class="tab-info">
								...
								<div class="address">
									...
									<div class="col-md-4 address-grid">
										...
										<div class="address-right">
											<h6>Location</h6>
											<p>kerala(Alappuzha, Ernakulam, Kottayam) India.
