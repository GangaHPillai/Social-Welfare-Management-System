...
%>
    <body>
        ...
        <form action="" method="post">
            <div class="container2" style="position:relative; top:150px;left:350px;">
...
sql="insert into donation_request(org_name,email,phno,purpose,description,account,category)values('"+name+"','"+email+"','"+phn+"','"+purpose+"','"+des+"','"+acc+"','womanwelfare')";
