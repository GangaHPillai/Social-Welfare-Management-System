                           ...
                           <a class="scroll" href="index.jsp">Home</a>				
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=handicrafts">Hand crafts</a>
									</li>
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=clayproducts">Clay product </a>
									</li>
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=papercraft">Paper crafts</a>
									</li>
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=woodcraft">Wood crafts</a>
									</li>
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=plasticcraft">Plastic crafts</a>
									</li>
									<li>
							...
							<li>
                                                            <a class="scroll" href="myorder.jsp">My Orders</a>
							</li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
                                                                            <a class="scroll" href="view_donation_requset.jsp?mode=orphanage">Orphange</a>
									</li>
									<li>
                                                                            <a class="scroll" href="view_donation_requset.jsp?mode=oldage_home">Oldage Home</a>
									</li>
                                                                        <li>
                                                                            <a class="scroll" href="view_donation_requset.jsp?mode=womenwelfare">Women Welfare</a>
									</li>
								</ul>
							</li>
