...
%>
    <body>
        <h3 style="position:relative;left:520px;top:155px;">DONATION REQUESTS</h3>
          <div class="container2" style="position:relative; top:165px;left:350px;">
 ...
 <input type="text" name="purpose" required="">                 
                ...
                <div class="row">
                        ...
                        <div  style="position:relative;right:550px; top:10px">                         
...
sql="insert into donation_request(org_name,email,phno,purpose,description,account,category)values('"+name+"','"+email+"','"+phn+"','"+purpose+"','"+des+"','"+acc+"','orphanage')";
