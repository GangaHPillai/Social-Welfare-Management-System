						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=woodcraft">Wood Craft</a>
									</li>
									
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=plasticcraft">Plastic Craft</a>
									</li>
									<li>
                                                                            <a class="scroll" href="product.jsp?mode=papercraft">Paper Craft</a>
									</li>
